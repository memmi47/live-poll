...
export default function Stage() {
  ...
  // Counts: live subscription or demo simulation.
  useEffect(() => {
    ...
    <div style={{ minHeight: '100vh', background: '#0b1322', padding: 32 }}>
      <div style={{ maxWidth: 1180, margin: '0 auto' }}>
        <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between' }}>
          <Link to="/admin" style={{ color: '#64748b', fontSize: 14, fontWeight: 600 }}>
            ← 관리자 대시보드
          </Link>
        ...
        <div
          style={{
            background: 'var(--lp-stage-bg)',
            borderRadius: 14,
            boxShadow: '0 8px 40px rgba(15,23,42,.3)',
            overflow: 'hidden',
            padding: '40px 48px',
          }}
        >
