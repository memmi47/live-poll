...
// Demo poll used when no Supabase env is configured.
const DEMO_POLL = {
  id: 'demo',
  pin: '482901',
...
export default function Voter() {
  const [stage, setStage] = useState('pin'); // pin | question | done
...
function PinStep({ pin, setPin, onEnter, busy, error }) {
  ...
  return (
    ...
    >
          ...
          return (
            <div
              ...
              style={{
                ...
                background: '#fff',
                border: `2px solid ${
                  filled || active ? 'var(--lp-primary)' : 'var(--lp-border)'
                }`,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
      ...
      {/* hidden numeric input drives the cells */}
      <input
        autoFocus
        inputMode="numeric"
        pattern="[0-9]*"
